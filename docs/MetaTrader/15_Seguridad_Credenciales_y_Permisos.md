...
Acceso de IA a línea de comandos: controlado, evitar mientras no se audite el alcance exacto (ver Q-004 en PREGUNTAS_ABIERTAS.md)
...
- [ ] `AI-initiated trading` sigue deshabilitado salvo decisión explícita y documentada en un ADR (`DECISIONS/`).
...
- [ ] Broker final verificado directamente contra el registro oficial de la CNMV (no solo fuentes secundarias) — ver `PREGUNTAS_ABIERTAS.md` Q-005.
- [ ] Plan de rollback/kill switch definido (Fase 7 del `ROADMAP.md`, explícitamente fuera de alcance de ejecución en esta fase).

## Fuentes consultadas

- F002 (ver `FUENTES.md`) — permisos de IA nativos del Terminal.
