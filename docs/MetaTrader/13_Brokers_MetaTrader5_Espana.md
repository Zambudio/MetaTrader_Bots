...
- F029 — ActivTrades, entidades del grupo (FCA, SCB, CMVM, FSC, BACEN/CVM), modo de netting FIFO — consultado vía búsqueda agregada de reseñas y comparativas — SECUNDARIA — consultado 2026-08-07 — passporting exacto a España no confirmado, ver `PREGUNTAS_ABIERTAS.md` Q-005.
