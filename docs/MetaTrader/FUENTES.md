...
| F004 | Sitio oficial MetaTrader 5 (es) — varias secciones | https://www.metatrader5.com/es | MetaQuotes | continuo | 2026-08-06 | OFICIAL | Base de `Web_METATRADER5.md`, contexto general de producto |
