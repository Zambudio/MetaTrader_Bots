...
**BOC (Break or Cancel)** — Política asociada a ejecución tipo bolsa/exchange; comportamiento detallado `[PENDIENTE]` de verificación (`04`, [`PREGUNTAS_ABIERTAS.md`](PREGUNTAS_ABIERTAS.md) Q-003).
