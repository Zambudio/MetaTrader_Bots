...
Existe un documento [`Web_METATRADER5.md`](raw/Web_METATRADER5.md) (fuente inmutable en `raw/`, no editar), elaborado el 06/08/2026 a partir del sitio web oficial. Se ha usado como punto de partida pero **no como fuente de verdad**: durante esta investigación se ha verificado directamente contra `metatrader5.com/en/releasenotes` y se ha corregido al menos un dato relevante (ver hallazgo sobre la build vigente en [`ESTADO_INVESTIGACION.md`](ESTADO_INVESTIGACION.md) y en `01_Arquitectura_y_Funcionamiento_MetaTrader5.md`).
...
- F004 — Sitio oficial MetaTrader 5 (es). Ver [`FUENTES.md`](FUENTES.md).
- `Promp_InicioMetaTrader_Investigar.md` (especificación de esta fase, documento interno del proyecto).
- [`Web_METATRADER5.md`](raw/Web_METATRADER5.md) (documento interno previo, tratado como fuente secundaria a contrastar, no como verdad).
