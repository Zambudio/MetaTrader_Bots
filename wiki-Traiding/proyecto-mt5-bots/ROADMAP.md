...
**Salida:** conocimiento suficiente para configurar sin improvisar. Ver Definition of Done en [`ESTADO_INVESTIGACION.md`](ESTADO_INVESTIGACION.md).
**Estado:** en cierre — ver auditoría final en [`ESTADO_INVESTIGACION.md`](ESTADO_INVESTIGACION.md) y resumen en este mismo archivo tras completarla.
...
- Decisión explícita y documentada en un ADR ([`DECISIONS/`](DECISIONS/README.md)) sobre si se habilita `AI-initiated trading` en algún grado, con qué justificación y límites.
