...
Esto corrige la hipótesis inicial del prompt maestro (que asumía 6060 como la más reciente): el dato de [`Web_METATRADER5.md`](raw/Web_METATRADER5.md) (build 6090) era el correcto. Ver [`PREGUNTAS_ABIERTAS.md`](PREGUNTAS_ABIERTAS.md) Q-001 sobre cómo tratar este dato de cara a la instalación real.
...
- F001, F002, F003 (ver [`FUENTES.md`](FUENTES.md)) — build vigente y MCP.
