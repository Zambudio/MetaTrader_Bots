...
1. **Build vigente: 6090 (30/07/2026), no 6060.** El prompt maestro asumía 6060 como la más reciente; el dato de [`Web_METATRADER5.md`](raw/Web_METATRADER5.md) (build 6090) era correcto. Ver `01_Arquitectura...` §1.
...
Ver [`PREGUNTAS_ABIERTAS.md`](PREGUNTAS_ABIERTAS.md) (Q-001 a Q-005). Ninguna bloquea el inicio de la Fase 1; Q-004 y Q-005 bloquean pasos concretos dentro de ella (ver `19_Plan_Puesta_en_Marcha.md`).
