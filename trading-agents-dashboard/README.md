...
- **Conocimiento de apoyo de la wiki**: cada agente (y el generador de MQL5) recibe automáticamente, como contexto adicional, las páginas de `wiki/` más relevantes para su rol/estrategia — selección por palabras clave, sin configuración manual. Detalle técnico en `server/README.md`.
