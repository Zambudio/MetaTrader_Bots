...
Una capacidad declarada DATA_NOT_AVAILABLE es una limitacion trazable; no invalida una hipotesis que no dependa de ella. No inventes cifras de spread ni slippage: si faltan, conserva DATA_NOT_AVAILABLE y deja que el smoke use solo costes realmente configurados por el tester.
